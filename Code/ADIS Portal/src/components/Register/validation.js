...
const FormExample = () => {
    ...
    const RegisterationSubmittion = () => {
        Axios.post("http://localhost:5000/adminapi/insert", {
            FirstName: firstName,
            LastName: lastName,
            EmailID: userEmail,
            City: city,
    ...
    return (
        <Container className="register-validation">
            <br />
            <Row>
                <br />
                <Col></Col>
                <Col xs={10}>
                    ...
                    <Form noValidate validated={validated} onSubmit={handleSubmit}>
                        ...
                        <Form.Group className="mb-3">
                            <a href="/login" className="register-link">Already Registered</a>
                        </Form.Group>
                        <Button type="submit" onClick={RegisterationSubmittion} >
                            {/* Register */}
                            <a href="/dashboard" >Register</a>
                        </Button>
                        {/* <Button type="submit" onClick={() => { alert.show('Oh look, an alert!') }} >
                            <Link to="/user" onClick={() => { alert.show('Oh look, an alert!') }} >Register</Link>
                        </Button> */}
                        {/* <div>{action}</div> */}
                        {/* <script>
                            function myFunction() {
